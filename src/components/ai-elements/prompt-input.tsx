...
export const PromptInputActionAddAttachments = ({
  ...
  const handleClick = useCallback(
    (event: BaseUIEvent<SyntheticEvent<HTMLDivElement, Event>>) => {
...
export const PromptInputActionAddScreenshot = ({
  ...
  const handleClick = useCallback(
    async (event: BaseUIEvent<ReactMouseEvent<HTMLDivElement>>) => {
      onClick?.(event);
...
export const PromptInputSubmit = ({
  ...
  const handleClick = useCallback(
    (event: BaseUIEvent<ReactMouseEvent<HTMLButtonElement>>) => {
